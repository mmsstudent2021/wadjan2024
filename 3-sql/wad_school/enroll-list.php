                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead>
                            <tr>
                                ...
                                <th class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Student</th>
                                <th class="px-6 py-3 text-end text-xs font-medium text-gray-500 uppercase">Batch</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200"><?= $row['enrollment_id'] ?></td>

                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200"><?= $row['student_name'] ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200"><?= $row['batch_name'] ?></td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium text-gray-800 dark:text-gray-200">
                                        <?= date("d M Y", strtotime($row['enrollment_created_at'])) ?>
                                        <br>
                                        <?= date("h : i A", strtotime($row['enrollment_created_at'])) ?>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium text-gray-800 dark:text-gray-200">
                                        ...
                                        <div class="inline-flex rounded-lg shadow-sm">
                                            ...
                                            <a class="py-3 px-4 inline-flex items-center gap-x-2 -ms-px first:rounded-s-lg first:ms-0 last:rounded-e-lg text-sm font-medium focus:z-10 border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="./batch-edit.php?row_id=<?= $row['enrollment_id'] ?>">
                                            ...
                                            <a class="py-3 px-4 inline-flex items-center gap-x-2 -ms-px first:rounded-s-lg first:ms-0 last:rounded-e-lg text-sm font-medium focus:z-10 border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" onclick="return confirm('Are you sure to delete?')" href="./batch-delete.php?row_id=<?= $row['enrollment_id'] ?>">
