 ...
 * @since 1.0.0
 */
class School_Education_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'school_education';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'school-education' ), $i ),
...
// Initialize.
$School_Education_Footer_Widgets = new School_Education_Footer_Widgets();